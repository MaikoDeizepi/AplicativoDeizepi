...
import kotlinx.android.synthetic.main.activity_calculadorade_ipvabk.*

class CalculadoradeIpvabkActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_calculadorade_ipvabk)
        ...
        spnEstados2.adapter = estadoAdapter



        btnIpvaCalcular2.setOnClickListener {
            val estados = spnEstados2.selectedItem.toString()
            ...
            if (estados == listaEstado[24] || estados == listaEstado[20] || estados == listaEstado[5]
                ...
                val valorcarro =edtValorCarro2.text.toString().toFloat()
                val ipva = (valorcarro * 2)/100
                txvValorIpva2.text = ipva.toString()+" Reais"
        ...
        btnIpvaLimpar2.setOnClickListener(){
            txvValorIpva2.text = " "
        }
        btnIpvaVoltar2.setOnClickListener(){
