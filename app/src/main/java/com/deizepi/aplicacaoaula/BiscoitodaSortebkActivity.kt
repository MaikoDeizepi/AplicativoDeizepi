...
import kotlinx.android.synthetic.main.activity_biscoitoda_sortebk.*

class BiscoitodaSortebkActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_biscoitoda_sortebk)
       ...
       val biscoitodasorte = arrayListOf<String>(
        ...
        btnbiscoitodescubrabk.setOnClickListener {
            txvBiscoitoSortebk.text = biscoitodasorte.random()
        }
        btnbiscoitovoltarbk.setOnClickListener(){
